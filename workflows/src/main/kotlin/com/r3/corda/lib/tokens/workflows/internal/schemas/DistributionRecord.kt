...
object DistributionRecordSchemaV1 : MappedSchema(
    ...
    @NamedQueries(
        NamedQuery(
            ...
            query = "FROM com.r3.corda.lib.tokens.workflows.internal.schemas.DistributionRecordSchemaV1\$DistributionRecord WHERE linearId = :linearId"
        ),
        NamedQuery(
            name = "DistributionRecord.findByLinearIdAndParty",
            query = "FROM com.r3.corda.lib.tokens.workflows.internal.schemas.DistributionRecordSchemaV1\$DistributionRecord WHERE linearId = :linearId AND party = :party"
        )
    )
